    ...
    <main id="home" className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-0 items-center w-full">
      ...
      <div className="flex flex-col gap-[5rem]">
        <div>
          ...
          <a href="https://github.com/mshujaat10" target="_blank" className="font-bold bg-blue-700 text-white rounded-lg py-2 px-4 md:px-7 md:text-lg">View My Projects</a>
        </div>
