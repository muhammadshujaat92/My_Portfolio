...
const Contact = () => {
    return (
        <main id='contact'>
            <h1 className='font-bold text-gray-600 text-3xl md:text-4xl mb-10 text-center'>Contact Me</h1>
            <form action={'https://formspree.io/f/mqkrykyl'} className="max-w-md mx-auto" method='POST'>
                <div className="relative z-0 w-full mb-5 group">
                    <input autoComplete='off' type="text" name="name" id="floating_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <textarea rows={8} id="floating_textarea" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " name='message'></textarea>
